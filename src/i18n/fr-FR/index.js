export default {
  ...
  TRIpartition1: 'Quota Q1 (textes des notes) ↑',
  TRIpartition2: 'Quota Q1 (textes des notes) ↓',
  TRIpartition3: 'Quota Q2 (fichiers des notes) ↑',
  TRIpartition4: 'Quota Q2 (fichiers des notes) ↓',
  TRIpartition5: '% utilisation de Q1 ↑',
  TRIpartition6: '% utilisation de Q1 ↓',
  ...
  PNOmctit: 'Attribution de mots clés',
  ...
  PNOm2: 'La note n\'a pas d\'exclusivité d\'écriture: pour pouvoir en définir les mots clés "groupe", il faut avoir le droit d\'écriture ou le pouvoir d\'animateur.',
  ...
  AMchg: 'Les droits ont changé : les validations des autres animateurs seront effacées. ' +
    ' Le choix ci-dessous de "valider" sera le seul enregistré (avec ces droits).',
  ...
  */
  ...
  MMCnomc: '(pas de mots clés)',
  MMCnomemo: '(pas de commentaire)',
  MMCcom: 'Commentaire:',
  MMCmc: 'Mots clés:',
