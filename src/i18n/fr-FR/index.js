export default {
  ...
  NPnosp: 'Aucun sponsoring n\est actuellement en cours ou récents',
  NPspex: 'Liste des sponsorings actuellement en cours ou récents',
  NPphr: 'Phrase de sponsoring: "{0}"',
  NPdlv: 'Date limite de validité: {0}',
  ...
  */
  ...
  // choix quotas
  CQt1: 'Quota pour les textes: {0}',
  CQt2: 'Quota pour les fichiers: {0}',
  CQmax: 'Max:{0}',
