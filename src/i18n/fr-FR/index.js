export default {
  ...
  PNFnv12: 'Révision(s) antérieure(s) ayant pour nom',
  PNFnv13: 'Cocher les révisions antérieures à SUPPRIMER (elles ne seront effectivement supprimées QUE si l\'enregistrement s\'est bien effectué).',
