export default {
  ...
  EX8051: 'Quota personnel dépassé pour le volume V1. Demande:{0} - Quota:{1}',
  EX8052: 'Quota personnel dépassé pour le volume V2. Demande:{0} - Quota:{1}',
  EX8053: 'Quota du contact dépassé pour le volume V1. Demande:{0} - Quota:{1}',
  EX8054: 'Quota du contact dépassé pour le volume V2. Demande:{0} - Quota:{1}',
  EX8055: 'Quota de l\'hébergeur du groupe dépassé pour le volume V1. Demande:{0} - Quota:{1}',
  EX8056: 'Quota de l\'hébergeur du groupe dépassé pour le volume V2. Demande:{0} - Quota:{1}',
  EX8061: 'Maximum de volume V1 pour les secrets du contact dépassé. Demande:{0} - Maximum:{1}',
  EX8062: 'Maximum de volume V2 pour les secrets du contact dépassé. Demande:{0} - Maximum:{1}',
