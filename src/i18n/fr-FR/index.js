export default {
  ...
  */
  ...
  PCPsyn: 'Synthèse',
  PCPpref0: 'Période référence pour le contrôle de la consommation : de la création du compte [{0}] à maintenant.',
  PCPpref1: 'Période référence pour le contrôle de la consommation : du début du mois précédent [{0}] à maintenant.',
  PCPpref2: 'Période référence pour le contrôle de la consommation : du passage en "compte autonome" [{0}] à maintenant.',
  PCPpref3: 'Période référence pour le contrôle de la consommation : du passage en "compte de l\'organistion" [{0}] à maintenant.',
  ...
  PCPlim: '{1}% de la limite',
  PCPqc: '{0} : limite maximale autosiée de consommation en rythme annuel.',
