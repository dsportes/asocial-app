export default {
  ...
  EX8319: '(BUG) Le quota de calcul de la partition est insuffisant pour accepter ce compte',
  EX8320: '(BUG) Le quota de nombre de documents de la partition est insuffisant pour accepter ce compte',
  EX8321: '(BUG) Le quota de volume de fichiers de la partition est insuffisant pour accepter ce compte',
  EX8322: '(BUG) Le quota de calcul pour les comptes A est insuffisant pour accepter ce compte',
  EX8323: '(BUG) Le quota de nombre de documents pour les comptes A est insuffisant pour accepter ce compte',
  EX8324: '(BUG) Le quota de volume de fichiers pour les comptes A est insuffisant pour accepter ce compte',
  EX8325: '(BUG) Le quota de calcul pour les comptes A est insuffisant pour accepter le nouveau quota',
  EX8326: '(BUG) Le quota de nombre de documents pour les comptes A est insuffisant pour accepter le nouveau quota',
  EX8327: '(BUG) Le quota de volume de fichiers pour les comptes A est insuffisant pour accepter le nouveau quota',
  EX8328: '(BUG) Le quota de calcul de la partition est insuffisant pour accepter le nouveau quota',
  EX8329: '(BUG) Le quota de nombre de documents de la partition est insuffisant pour accepter le nouveau quota',
  EX8330: '(BUG) Le quota de volume de fichiers de la partition est insuffisant pour accepter le nouveau quota',
  EX8331: '(BUG) Le quota global de nombre de documents fixé pour l\'espace ne permet pas d\'attribuer ce quota.',
  EX8332: '(BUG) Le quota global de volume de fichiers fixé pour l\'espace ne permet pas d\'attribuer ce quota.',
  EX8333: '(BUG) Le quota global de calcul fixé pour l\'espace ne permet pas d\'attribuer ce quota.',
  ...
  PTquta: 'Quotas attribués globalement aux comptes "A"',
