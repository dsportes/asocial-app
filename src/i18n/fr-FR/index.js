...
// ChoixEmoji
  ...
  SAVddel: 'Ce compte est le dernier délégué de sa partition.',
  SAVnna: 'Disparition de note(s) personnelle(s) de l\'avatar',
  SAVnbvf: '{0} note(s) - {1} de fichiers',
  SAVchats: ' x | Un "chat" va disparaître : | {count} "chats" vont disparaître : ',
  SAVspons: ' x | Un "sponsoring" en attente sera annulé | {count} "sponsorings" en attente seront annulés',
  SAVgr0: ' x | L\'avatar ne sera plus membre du groupe suivant: | L\'avatar ne sera plus membre des {count} groupes suivants :',
  ...
  SAVgr3: ' x | Cet avatar est le dernier animateur du groupe suivant : | Cet avatar est le dernier animateur des {count} groupes suivants :',
  ...
  SAVvola: '{0} note(s) personnelle(s) de l\'avatar. {1} de fichiers',
  SAVvolg: '{0} note(s) du ou des groupes hébergés résiliés. {1} de fichiers',
  SAVabo: 'Récupération de ressources décomptées dans l\'abonnement:',
