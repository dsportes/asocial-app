export default {
  ...
  // page Alerte, blocage, compta, chats
  ...
  */
  ...
  CPTtn0: 'Alerte de l\'administrateur technique de l\'application',
  CPTtn1: 'Alerte pour tous les comptes de la tranche, du Comptable ou d\'un sponsor',
  CPTtn2: 'Alerte spécifique au compte (émise par le Comptable ou un sponsor de la tranche)',
  CPTtn3: 'Alerte automatique de surveillance de l\'abonnement (excès de volume)',
  CPTtn4a: 'Alerte automatique de surveillance du solde (crédits - coûts)',
  CPTtn4: 'Alerte automatique de surveillance de l\'excès de consommation',
  ...
  // Aperçu Alerte
  ANro1: 'L\'Administrateur ne peut éditer qu\'une Alerte globale',
  ANmx1: 'L\'Administrateur ne peut déclarer qu\'une Alerte globale',
  ANro2: 'Le Comptable ne peut pas éditer une Alerte globale, seul l\'Administrateur technique le peut',
  ANmx2: 'Le Comptable ne peut pas déclarer une Alerte globale, seul l\'Administrateur technique le peut',
  ANro3: 'Un compte, sponsor ou non, ne peut pas éditer une Alerte globale, seul l\'Administrateur technique le peut',
  ANmx3: 'Un compte, sponsor ou non, ne peut pas déclarer une Alerte globale, seul l\'Administrateur technique le peut',
  ANro4: 'Seuls le Comptable et le(s) sponsor(s) peuvent éditer une Alerte collective applicable à tous les comptes partageant la même tranche de quotas',
  ANmx4: 'Seuls le Comptable et le(s) sponsor(s) peuvent déclarer une Alerte collective applicable à tous les comptes partageant la même tranche de quotas',
  ANax5: 'Un sponsor ne peut pas éditer une Alerte déclarée par le Comptable',
  ANax6: 'Un sponsor ne peut pas éditer une Alerte déclarée par le Comptable',
  ANro7: 'Seuls le Comptable et le(s) sponsor(s) peuvent éditer une Alerte pour un compte"',
  ANmx7: 'Seuls le Comptable et le(s) sponsor(s) peuvent déclarer une Alerte pour un compte"',
...
`,
  ...
  A_page_compta: 'Alertes, Abonnement, Crédits, chats d\'urgence',
