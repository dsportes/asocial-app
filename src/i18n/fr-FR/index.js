export default {
  ...
  */
  ...
  // Aperçu notification
  ANro1: 'L\'Administrateur ne peut pas éditer une notification de "tribu" ou de "compte"',
  ANmx1: 'L\'Administrateur ne peut pas déclarer une notification de "tribu" ou de "compte"',
  ANro2: 'Le Comptable ne peut pas éditer une notification globale, seul l\'Administrateur le peut',
  ANmx2: 'Le Comptable ne peut pas déclarer une notification globale, seul l\'Administrateur le peut',
  ANro3: 'Un compte, sponsor ou non, ne peut pas éditer une notification globale, seul l\'Administrateur le peut',
  ANmx3: 'Un compte, sponsor ou non, ne peut pas déclarer une notification globale, seul l\'Administrateur le peut',
  ANro4: 'Seuls le Comptable et le(s) sponsor(s) de la tribu peuvent éditer une notification de niveau "tribu"',
  ANmx4: 'Seuls le Comptable et le(s) sponsor(s) de la tribu peuvent déclarer une notification de niveau "tribu"',
  ANax5: 'Un sponsor ne peut pas éditer une notification de niveau "tribu" déclarée par le Comptable',
  ANax6: 'Un sponsor ne peut pas éditer une notification de niveau "compte" déclarée par le Comptable',
  ANro7: 'Seuls le Comptable et le(s) sponsor(s) de la tribu peuvent éditer une notification de niveau "compte"',
  ANmx7: 'Seuls le Comptable et le(s) sponsor(s) de la tribu peuvent déclarer une notification de niveau "compte"',

  ANcible1: 'sur tous les comptes',
  ANcible2: 'sur les comptes de la tribu {0}',
  ANcible3: 'sur le compte {0}',
  ...
  ANlong3: 'Les mises à jour sont interdites, tout reste consultable. Toutefois les "chats" avec le Comptable et les sponsors de la tribu restent possibles',
  ANlong4: 'Rien n\'est consultable et les mises à jour sont interdites. Toutefois les "chats" avec le Comptable et les sponsors de la tribu restent possibles',
  ...
  SAVgr2: ' ? | Un groupe que vous hébergez va disparaître dans 3 mois : | {count} groupes que vous hébergez vont disparaître dans 3 mois :',
  SAVgr3: ' ? | Un groupe dont vous êtes le dernier animateur : | {count} groupes dont vous êtes le dernier animateur :',
  SAVgr0: ' ? | Un groupe dont vous êtes membre : | {count} groupes dont vous êtes membre :',
  SAVdspt:  'Votre tribu n\'auru plus de sponsors, vous êtes le dernier.',
  ...
  SAVvol: 'Volumes rendus disponible pour le compte par la suppression de l\'avatar:',
