export default {
  ...
  */
  ...
  PPmuter: 'Mutation en compte "O"',
  PPmutpc: 'Cette phrase de contact n\'est pas celle déclarée par le compte.',
  PPmutpc2: 'Donner la phrase de contact de l\'avatar pour s\'assurer que c\'est bien sa volonté.',
  PPchatreq: 'Un "chat" avec le compte doit avoir été établi avant de le passer en compte "O".',
  PPmut: 'Passer ce compte en "COMPTE DE L\'ORGANISATION"',
